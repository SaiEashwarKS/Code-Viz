...
{
	this.commands = [];
	this.cmd("CreateRectangle", this.activationRecordId, "int x		10", Example.ELEMENT_WIDTH, Example.ELEMENT_HEIGHT, Example.INSERT_X, Example.INSERT_Y);
	this.cmd("Step");
	this.cmd("CreateRectangle", this.activationRecordId + 1, "int *p		", Example.ELEMENT_WIDTH, Example.ELEMENT_HEIGHT, Example.INSERT_X, Example.INSERT_Y +(2 * Example.ELEMENT_HEIGHT));
	this.cmd("Step");
	this.cmd("Move", this.activationRecordId, Example.INSERT_X +(2 * Example.ELEMENT_WIDTH), Example.INSERT_Y);
	this.cmd("Move", this.activationRecordId + 1, Example.INSERT_X, Example.INSERT_Y);
	this.cmd("Step");
